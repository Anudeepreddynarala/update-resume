...
\begin{document}
    ...
    \section{Summary}
        \begin{onecolentry}
            {A driven AI product leader with a proven ability to take complex ideas from ideation to launch. Excels in leveraging emerging technologies to drive business growth and deliver tangible results for high-growth companies.}
        \end{onecolentry}
